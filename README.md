...
Цуркан Д. В. | БПИ195 |<ul><li>4.	Архитектурные представления </li> <li>4.1.	Представление прецедентов  </li> <li>4.2.	Логическое представление </li> <li>4.3.	Представление архитектуры процессов  </li> </ul>
